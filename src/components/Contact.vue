<template>
  <div>
    ...
    <div v-if="isOpen"
      ...
      <form action="" name="contact-portfolio" netlify class=" space-y-3 mt-5 flex flex-col justify-center items-center">
...
<style scoped lang="scss">
  ...
  input[type=submit] {
    @apply w-32 m-0 self-end;
    color: rgba(0, 0, 0, 0.45);

    &:hover {
      @apply text-lightColor bg-persoBlue border-2 border-lightColor box-border transition-all;
    }
  }
</style>